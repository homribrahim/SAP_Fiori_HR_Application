		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Official RH Application",
									"targetURL": "#brahimproject-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"brahimproject-display": {
								"semanticObject": "brahimproject",
								"action": "display",
								"description": "Official RH Application",
								"title": "Official RH Application",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=brahim.project",
									"url": sap.ui.require.toUrl("brahim/project")
								}
							}
						}
					}
